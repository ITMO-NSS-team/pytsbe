...
about: Want us to add any features to pytsbe?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with pytsbe. Please take the time to
...
<!--
  Why do you want to see this feature in pytsbe? What use cases does it support?
-->
