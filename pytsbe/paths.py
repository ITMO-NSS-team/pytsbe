...
def get_path_for_dataset(dataset_name: str):
    path_by_dataset_name = {'FRED': os.path.join(get_data_path(), 'fred.csv'),
                            ...
                            'M4_hourly_test': os.path.join(get_data_path(), 'M4HourlyTest.csv'),
                            'M4_daily_test': os.path.join(get_data_path(), 'M4DailyTest.csv'),
                            'M4_monthly_test': os.path.join(get_data_path(), 'M4MonthlyTest.csv'),
                            'M4_quarterly_test': os.path.join(get_data_path(), 'M4QuarterlyTest.csv'),
                            'M4_weekly_test': os.path.join(get_data_path(), 'M4WeeklyTest.csv'),
                            'M4_yearly_test': os.path.join(get_data_path(), 'M4YearlyTest.csv'),
