...
class TPOTForecaster(AutoMLForecaster):
    """
    Class for time series forecasting with TPOT AutoML framework. Launch as a
    ...
    def __init__(self, **params):
        ...
        default_params = {'timeout': 2, 'generations': 3, 'population_size': 2}
